  ...
  return (
    <div className="flex items-center justify-center h-64">
      <div className="glass-panel flex items-center gap-3 rounded-2xl px-5 py-4 elevation-sm">
        <Spinner size={24} />
        <span className="text-sm font-medium text-[var(--ink-soft)]">Yuklanmoqda...</span>
      </div>
    </div>
  );
}
...
export function EmptyState({ title = "Hech narsa topilmadi", subtitle, icon: Icon = PackageOpen }) {
  return (
    <div className="relative flex flex-col items-center justify-center px-6 py-16 text-center text-[var(--ink-soft)]">
      ...
      <div className="relative mb-4 rounded-2xl border border-[color-mix(in_srgb,var(--accent)_20%,transparent)] bg-[var(--accent-soft)] p-4 text-[var(--accent-strong)]">
        <Icon size={34} />
      </div>
